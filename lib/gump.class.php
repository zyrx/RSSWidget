...
{	
	 ...
	 * @return string	
	 */
	public function get_readable_errors($convert_to_string = false, $field_class="field", $error_class="error-messages")
	{
		...
		if(!$convert_to_string) {
			...
			//HTML tag modified by @zyrx
			$buffer = "<ul class=\"$error_class\">";
			foreach($resp as $s) {
				$buffer .= "<li>$s</li>";
			}
			return $buffer."</ul>";
